...
- Core: `https://unpkg.com/@aevantec/litevue@0.5.5/dist/litevue.iife.js` <!-- x-release-please-version -->
- One plugin: `https://unpkg.com/@aevantec/litevue@0.5.5/dist/plugins/mask.iife.js` <!-- x-release-please-version -->
- All plugins: `https://unpkg.com/@aevantec/litevue@0.5.5/dist/litevue-plugins.iife.js` <!-- x-release-please-version -->
