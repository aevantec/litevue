...
- Global build: `https://unpkg.com/@aevantec/litevue@0.5.5/dist/litevue.iife.js` <!-- x-release-please-version --> — exposes the `LiteVue` global, supports the `init` attribute.
- ESM build: `https://unpkg.com/@aevantec/litevue@0.5.5/dist/litevue.mjs` <!-- x-release-please-version --> — use with `<script type="module">`.
