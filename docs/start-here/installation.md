...
- Global build: `https://unpkg.com/@aevantec/litevue@0.5.0/dist/litevue.iife.js` — exposes the `LiteVue` global, supports the `init` attribute.
- ESM build: `https://unpkg.com/@aevantec/litevue@0.5.0/dist/litevue.mjs` — use with `<script type="module">`.
