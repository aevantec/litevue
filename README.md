...
- This is pretty new. There are probably bugs and there might still be API changes, so **use at your own risk.** Is it usable though? Very much. Check out the [examples](https://github.com/abiacarl/lite-vue/tree/main/examples) to see what it's capable of.
...
- Global build: `https://unpkg.com/lite-vue@0.2.2/dist/lite-vue.iife.js`
  - exposes `LiteVue` global, supports auto init
- ESM build: `https://unpkg.com/lite-vue@0.2.2/dist/lite-vue.es.js`
